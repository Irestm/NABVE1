...
CAPABILITIES_MESSAGES: dict[str, str] = {
    "ru": (
        ...
        "Вести календарь событий и напоминать о них голосом заранее. Учить слова и термины карточками "
        "во вкладке «Обучение» — свои наборы или импорт из Quizlet, с играми и голосовым режимом. "
        "Хранить пароли. "
    ...
    "uk": (
        ...
        "заздалегідь. Вчити слова й терміни картками у вкладці «Навчання» — власні набори або "
        "імпорт із Quizlet, з іграми та голосовим режимом. Зберігати паролі. Шукати в "
    ...
    "en": (
        ...
        "Keep a calendar of events and announce them out loud ahead of time. Learn words and terms "
        "with flashcards in the Learning tab — your own sets or ones imported from Quizlet, with "
        "games and a voice mode. Store passwords. "
