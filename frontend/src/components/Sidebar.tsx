import { Dumbbell, MessageCircle, Plug, Terminal, Wand2 } from "lucide-react";
...
export type Page = "assistant" | "commands" | "my_commands" | "fitness" | "integrations";
...
const ITEMS: SidebarItem[] = [
  ...
  { id: "my_commands", label: "Мои команды", icon: <Wand2 size={26} />, accent: "amber" },
