    ...
    <div className="gesture-mode" style={style}>
      ...
      {calibration ? (
        ...
        <ul className="gesture-mode__legend">
          ...
          <li>
            <b>Сожми руку в кулак</b> — клик. Пока кулак сжимается, курсор замирает на месте —
            клик попадёт туда, куда навёл.
          </li>
          <li>
            <b>Кулак и веди</b> — выделение / перетаскивание (курсор идёт за ладонью). Разжал
            кулак — отпустил.
          </li>
          <li>
